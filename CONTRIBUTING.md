...
```bash
git clone https://github.com/caffeinated1/aidatacommunitygoal
cd aidatacommunitygoal
...
```bash
cp data/jurisdictions/template.json \
   data/jurisdictions/vermont.json
```
...
Tests enforce most of this. If `python3 tests/test_guide.py` passes,
