...
anyone can build on. Adapted from a document published by Mark Cuban on
[LinkedIn](https://lnkd.in/p/e-Pbqzrm).

[**Read the guide →**](https://caffeinated1.github.io/aidatacommunitygoal/) ·
[API](https://caffeinated1.github.io/aidatacommunitygoal/api/v1/index.json) ·
...
```bash
BASE=https://caffeinated1.github.io/aidatacommunitygoal/api/v1
...
python3 serve.py              # build and serve on :8000
python3 tests/test_guide.py         # 26 checks over data, API, and site
```
...
section, or an unknown instrument — a broken reference should fail the build, not become a dead link on
a public page.
...
[templates](https://github.com/caffeinated1/aidatacommunitygoal/issues/new/choose).
...
Originally built in
[caffeinated1/configurationRotBot](https://github.com/caffeinated1/configurationRotBot)
