...
[`api/v1/coverage.json`](https://caffeinated1.github.io/aidatacommunitygoal/api/v1/coverage.json).

**One claim is a complete contribution.** Use the
[source form](https://github.com/caffeinated1/aidatacommunitygoal/issues/new?template=source.yml)
— no JSON required.
...
[correction](https://github.com/caffeinated1/aidatacommunitygoal/issues/new?template=correction.yml).
